...
## Tasks completed
- [x] [0-isupper.c](https://github.com/cristian-encalada/holbertonschool-low_level_programming/blob/master/0-isupper.c)
...
julien@ubuntu:~/$ 
```
- [x] [1-isdigit.c](https://github.com/cristian-encalada/holbertonschool-low_level_programming/blob/master/more_functions_nested_loops/1-isdigit.c)
...
julien@ubuntu:~/$ 
```
- [x] [2-mul.c](https://github.com/cristian-encalada/holbertonschool-low_level_programming/blob/master/more_functions_nested_loops/2-mul.c)
...
julien@ubuntu:~/$ 
```
- [x] [3-print_numbers.c](https://github.com/cristian-encalada/holbertonschool-low_level_programming/blob/master/more_functions_nested_loops/3-print_numbers.c)
...
julien@ubuntu:~/$ 
```
- [x] [4-print_most_numbers.c](https://github.com/cristian-encalada/holbertonschool-low_level_programming/blob/master/more_functions_nested_loops/4-print_most_numbers.c)
	- Write a function that prints the numbers, from 0 to 9, followed by a new line.
...
julien@ubuntu:~/$ 
```
- [x] [5-more_numbers.c](https://github.com/cristian-encalada/holbertonschool-low_level_programming/blob/master/more_functions_nested_loops/5-more_numbers.c)
...
julien@ubuntu:~/
```
- [x] [6-print_line.c](https://github.com/cristian-encalada/holbertonschool-low_level_programming/blob/master/more_functions_nested_loops/6-print_line.c)
...
julien@ubuntu:~/$ 
```
- [x] [7-print_diagonal.c](https://github.com/cristian-encalada/holbertonschool-low_level_programming/blob/master/more_functions_nested_loops/7-print_diagonal.c)
...
julien@ubuntu:~/$ 
 ```
- [x] [8-print_square.c](https://github.com/cristian-encalada/holbertonschool-low_level_programming/blob/master/more_functions_nested_loops/8-print_square.c)
...
julien@ubuntu:~/$ 
```
- [x] [9-fizz_buzz.c](https://github.com/cristian-encalada/holbertonschool-low_level_programming/blob/master/more_functions_nested_loops/9-fizz_buzz.c)
...
julien@ubuntu:~/$ 
```
- [x] [10-print_triangle.c](https://github.com/cristian-encalada/holbertonschool-low_level_programming/blob/master/more_functions_nested_loops/10-print_triangle.c)
...
julien@ubuntu:~/$
```
- [x] [100-prime_factor.c](https://github.com/cristian-encalada/holbertonschool-low_level_programming/blob/master/more_functions_nested_loops/100-prime_factor.c)
	- The prime factors of ``1231952`` are ``2``, ``2``, ``2``, ``2``, ``37`` and ``2081``.
	- Write a program that finds and prints the largest prime factor of the number ``612852475143``, followed by a new line.
		- You are allowed to use the standard library
		- Your program will be compiled with this command: ``gcc -Wall -pedantic -Werror -Wextra -std=gnu89 100-prime_factor.c -o 100-prime_factor -lm``
- [x] [101-print_number.c](https://github.com/cristian-encalada/holbertonschool-low_level_programming/blob/master/more_functions_nested_loops/101-print_number.c)
